...
Function mpv-fast-4k {
  Invoke-Expression "mpv.com --ytdl-format=`"bestvideo[height<=2160][protocol^=m3u]/bestvideo[height<=2160]+bestaudio[protocol^=m3u]/bestaudio`" $env:PLAYER_ARGUMENTS $args"
}
Function mpv-fast-2k {
  Invoke-Expression "mpv.com --ytdl-format=`"bestvideo[height<=1440][protocol^=m3u]/bestvideo[height<=1440]+bestaudio[protocol^=m3u]/bestaudio`" $env:PLAYER_ARGUMENTS $args"
}
Function mpv-fast-1080 {
  Invoke-Expression "mpv.com --ytdl-format=`"bestvideo[height<=1080][protocol^=m3u]/bestvideo[height<=1080]+bestaudio[protocol^=m3u]/bestaudio`" $env:PLAYER_ARGUMENTS $args"
}
Function mpv-1080 {
