...
$env:DLARGUMENTS="-o '%(title)s.%(ext)s' --write-sub --all-subs --write-comments --embed-subs --concurrent-fragments 8 --hls-prefer-native --ignore-errors --downloader aria2c --downloader-args 'aria2c:$env:DOWNLOADARGS'"
