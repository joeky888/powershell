...
Function mpv-1080 {
  mpv.exe --ytdl-format="bestvideo[height<=1080][fps<=30]+bestaudio/best" --cache=1048576 --cache-secs=1200 $args
}
Function mpv-720 {
  mpv.exe --ytdl-format="bestvideo[height<=720][fps<=30]+bestaudio/best" --cache=600000 --cache-secs=1200 $args
}
