...
Function mpv-fast-4k {
  Invoke-Expression "mpv.com --cache=yes --ytdl-raw-options=no-check-certificate=,concurrent-fragments=8 --audio-file=`"$(yt-dlp.exe --get-url -f 'bestaudio[protocol^=m3u]' $args)`" `"$(yt-dlp.exe --write-sub --write-auto-sub --sub-format vtt --print "%(requested_subtitles.:.url)j" --sub-langs 'en.*,zh.*' $1 | jq -r '[.[] | `"--sub-file=`" + .] | join(`" `")')`" `"$(yt-dlp.exe --get-url -f 'bestvideo[height<=2160][protocol^=m3u][vcodec!^=av01]' $args)`" --force-media-title='$(yt-dlp.exe --get-title $args)'"
}
Function mpv-fast-2k {
  Invoke-Expression "mpv.com --cache=yes --ytdl-raw-options=no-check-certificate=,concurrent-fragments=8 --audio-file=`"$(yt-dlp.exe --get-url -f 'bestaudio[protocol^=m3u]' $args)`" `"$(yt-dlp.exe --write-sub --write-auto-sub --sub-format vtt --print "%(requested_subtitles.:.url)j" --sub-langs 'en.*,zh.*' $1 | jq -r '[.[] | `"--sub-file=`" + .] | join(`" `")')`" `"$(yt-dlp.exe --get-url -f 'bestvideo[height<=1440][protocol^=m3u][vcodec!^=av01]' $args)`" --force-media-title='$(yt-dlp.exe --get-title $args)'"
}
Function mpv-fast-1080 {
  Invoke-Expression "mpv.com --cache=yes --ytdl-raw-options=no-check-certificate=,concurrent-fragments=8 --audio-file=`"$(yt-dlp.exe --get-url -f 'bestaudio[protocol^=m3u]' $args)`" `"$(yt-dlp.exe --write-sub --write-auto-sub --sub-format vtt --print "%(requested_subtitles.:.url)j" --sub-langs 'en.*,zh.*' $1 | jq -r '[.[] | `"--sub-file=`" + .] | join(`" `")')`" `"$(yt-dlp.exe --get-url -f 'bestvideo[height<=1080][protocol^=m3u][vcodec!^=av01]' $args)`" --force-media-title='$(yt-dlp.exe --get-title $args)'"
}
Function mpv-1080 {
