...
$env:PLAYER_ARGUMENTS="--osd-font='MicrosoftYaHei' --cache=yes --cache-dir=`"$ENV:Temp`" --cache-on-disk=yes --ytdl-raw-options=`"no-check-certificate=,yes-playlist=,ignore-errors=`""
Function aria2c {
